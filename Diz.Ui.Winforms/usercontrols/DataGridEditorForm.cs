...
public partial class DataGridEditorForm : Form, IDataGridEditorForm
{
    ...
    {
        UpdateSaveOptionStates(saveEnabled: true, saveAsEnabled: true, closeEnabled: true);
        // UpdateWindowTitle(); // handled by Project_PropertyChanged() now?
    }
    ...
    private void exportLogToolStripMenuItem_Click(object sender, EventArgs e) =>
        MainFormController.ConfirmSettingsThenExportAssembly();

    private void aboutToolStripMenuItem_Click(object sender, EventArgs e) =>
        MainFormController.ViewFactory.GetAboutView().Show();
